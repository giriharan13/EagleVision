...
public class BuyerReviewService {
	...
	public ShopReview createShopReview(CreateShopReviewRequest createShopReviewRequest,Shop shop) {
	...
	public ItemReview createItemReview(CreateReviewRequest createReviewRequest,Item item){
