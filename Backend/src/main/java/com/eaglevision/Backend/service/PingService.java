...
public class PingService {
	...
	public Ping createPing(Item item,CreatePingRequest createPingRequest) {
		...
		else
		{
			...
			VendorResponsePing vendorResponsePing = new VendorResponsePing(createPingRequest.getQuantity(),item,vendor);
