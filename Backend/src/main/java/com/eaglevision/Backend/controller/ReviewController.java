...
public class ReviewController {
	...
	@Autowired
	public ReviewController(ReviewService reviewService, BuyerReviewService buyerReviewService,
			ShopReviewService shopReviewService, ItemReviewService itemReviewService) {
	...
	public ResponseEntity<ShopReview> updateShopReview(@PathVariable Integer shopId, @PathVariable Integer reviewId,
			@RequestBody ShopReview updatedShopReview) {
	...
	public ResponseEntity<ItemReview> updateItemReview(@PathVariable Integer shopId, @PathVariable Integer itemId,
			@PathVariable Integer reviewId, @RequestBody ItemReview updatedItemReview) {
	...
	public ResponseEntity<String> deleteItemReview(@PathVariable Integer shopId, @PathVariable Integer itemId,
