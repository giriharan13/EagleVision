...
export default function LandingPageForVendors({featuresRef,pricingRef,contactRef}){

    const text = "Reach more customers, grow your business, and connect with local shoppers effortlessly. Sell with ease and expand your street presence today!"
            ...
            <section className="container-fluid p-0 mx-0" id="hero">
                <div className="m-5">
                    <div className="d-flex mx-0 pt-2 bg-transparent rounded align-items-center justify-content-center mh-100 mb-5">
                        <img src={VendorsLogo} style={{width:400}}></img>
                    </div>
                    <div className="d-flex text-white flex-column">
                        <div className="d-flex align-items-center justify-content-center">
                            <h5 className="text-center" style={{fontFamily:"Kanit",fontWeight:700}}> Showcase Your Products to Nearby Buyers!</h5>
                        </div>
                        <div className="d-flex align-items-center justify-content-center">
                        ...
                        <div className="d-flex flex-column align-items-end justify-content-end">
                            <div className="d-flex flex-column align-items-center justify-content-center bg-light p-4 m-2  rounded-4 " >
                                <h5 className="text-center text-primary fw-bold" style={{fontFamily:"Kanit"}}>Also check out EagleVision for buyers!</h5>
                                <Link to="/" className="navbar-brand"> 
                                    <img src={Logo} className="navbar-brand" style={{width:200}}/>
                                </Link>
                            </div>
                        </div>
                    </div>
                        ...
                        <ul className="d-flex p-4 align-items-center justify-content-center list-unstyled">
                            {
                                vendorFeatures.map((feature)=>{
                                    return <li className="d-flex flex-column align-items-stretch align-self-stretch justify-content-center bg-primary rounded-4 p-4 m-4 flex-grow-1">
                                        <div className="d-flex align-items-center justify-content-center">
                                            <motion.div className="bg-white rounded-circle py-2 px-3 m-2" style={{width:"fit-content"}} 
                                        ...
                                        <div className="d-flex flex-column text-primary text-center text-white">
                                            ...
                                            <p style={{fontFamily:"Kanit"}}>{feature.description}</p>
                                        </div>
                                        {
